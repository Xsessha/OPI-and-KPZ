    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('WAITING', 'Waiting'), ('DRAWN', 'Drawn')], default='WAITING', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wishlist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='events.wishlist')),
            ],
            options={
                'abstract': False,
            },
